      ...
      return `
        ...
        <head>
          ...
          <style>
            ...
            .scorm-content { flex: 1; border: none; background: white; }
            .loading {
              display: flex;
              align-items: center;
        ...
        <body>
          <div class="scorm-container">
            ...
            <div class="loading" id="loading">
              ...
              Loading interactive course content...
            </div>
            <iframe 
              src="${contentUrl}" 
              class="scorm-content" 
          ...
          <script>
            ...
            document.getElementById('scorm-content').onload = function() {
              try {
                this.contentWindow.parent.API = window.API;
                console.log('🔗 SCORM API connected to course content');
              } catch (error) {
                console.log('⚠️ Could not connect API (cross-origin)');
              }
            };
